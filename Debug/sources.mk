...
lwip/src/netif/ppp \
source \
source/HAL/EthernetInterface \
source/HAL/EthernetInterface/Test \
source/HAL/EthernetInterface/protocols \
source/HAL/LEDDriverInterface \
source/HAL/RTC \
source/HAL/TimerModule \
source/HALInterface/Ethernet \
source/Middleware/FrameBufferManager \
source/Middleware/LogManager \
source/Middleware/MessageLayerParser \
source/Middleware/SessionManager \
source/application/DisplayController \
source/application/MessageHandler/InitializationCommand \
source/application/MessageHandler/MutualControlCommand \
source/application/MessageHandler \
startup \
usb/host/class \
usb/host \
usb/phy \
