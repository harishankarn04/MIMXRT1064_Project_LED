...
C_SRCS += \
../source/Middleware/FrameBufferManager/FrameBufferManager.c 

C_DEPS += \
./source/Middleware/FrameBufferManager/FrameBufferManager.d 

OBJS += \
./source/Middleware/FrameBufferManager/FrameBufferManager.o 


# Each subdirectory must supply rules for building sources it contributes
source/Middleware/FrameBufferManager/%.o: ../source/Middleware/FrameBufferManager/%.c source/Middleware/FrameBufferManager/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-Middleware-2f-FrameBufferManager

clean-source-2f-Middleware-2f-FrameBufferManager:
	-$(RM) ./source/Middleware/FrameBufferManager/FrameBufferManager.d ./source/Middleware/FrameBufferManager/FrameBufferManager.o

.PHONY: clean-source-2f-Middleware-2f-FrameBufferManager
