...
source/application/MessageHandler/%.o: ../source/application/MessageHandler/%.c source/application/MessageHandler/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-application-2f-MessageHandler

clean-source-2f-application-2f-MessageHandler:
	-$(RM) ./source/application/MessageHandler/ProcessCommand.d ./source/application/MessageHandler/ProcessCommand.o

.PHONY: clean-source-2f-application-2f-MessageHandler
