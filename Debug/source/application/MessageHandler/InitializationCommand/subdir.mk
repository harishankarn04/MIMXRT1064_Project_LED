...
C_SRCS += \
../source/application/MessageHandler/InitializationCommand/InitializationRequest.c \
../source/application/MessageHandler/InitializationCommand/InitializationResponce.c 

C_DEPS += \
./source/application/MessageHandler/InitializationCommand/InitializationRequest.d \
./source/application/MessageHandler/InitializationCommand/InitializationResponce.d 

OBJS += \
./source/application/MessageHandler/InitializationCommand/InitializationRequest.o \
./source/application/MessageHandler/InitializationCommand/InitializationResponce.o 


# Each subdirectory must supply rules for building sources it contributes
source/application/MessageHandler/InitializationCommand/%.o: ../source/application/MessageHandler/InitializationCommand/%.c source/application/MessageHandler/InitializationCommand/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-application-2f-MessageHandler-2f-InitializationCommand

clean-source-2f-application-2f-MessageHandler-2f-InitializationCommand:
	-$(RM) ./source/application/MessageHandler/InitializationCommand/InitializationRequest.d ./source/application/MessageHandler/InitializationCommand/InitializationRequest.o ./source/application/MessageHandler/InitializationCommand/InitializationResponce.d ./source/application/MessageHandler/InitializationCommand/InitializationResponce.o

.PHONY: clean-source-2f-application-2f-MessageHandler-2f-InitializationCommand
