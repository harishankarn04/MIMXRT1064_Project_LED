                              ...
                              int y)
{
    ...
    // int pen_y  = shaped.ascender;
    // int height = shaped.ascender + shaped.descender;
...
//            	px = pen_x + shaped.glyphs[i].x_offset + g->bitmap_left + col;
//            	py = pen_y - shaped.glyphs[i].y_offset - g->bitmap_top + row;
