...
/**
 * @brief Initializes all board-level hardware required for Ethernet.
 *
 * Includes pinmux, clocks, debug console, PHY reset, and MDIO setup.
 * Also registers MDIO read/write functions for the PHY driver.
 */
